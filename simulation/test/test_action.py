...
class TestAction(unittest.TestCase):
    ...
    def test_successful_move_action(self):
        game_state = GameState(WorldMap(HugeGrid()), self.avatar_manager)
    ...
    def test_failed_move_action(self):
        game_state = GameState(WorldMap(EmptyGrid()), self.avatar_manager)
        MoveAction(direction.NORTH).apply(game_state, self.avatar)
    ...
    def test_move_action_to_score_square(self):
        game_state = GameState(WorldMap(ScoreOnOddXGrid()), self.avatar_manager)
